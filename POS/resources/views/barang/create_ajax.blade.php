        ...
        <div class="modal-content bg-dark">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="" type="number" name="harga_beli" id="harga_beli" class="form-control" step="1" required>
                    <small id="error-harga_beli" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Harga Jual</label>
                    <input value="" type="number" name="harga_jual" id="harga_jual" class="form-control" step="1" required>
